...
public class DoctorController implements Initializable {
    ...
    void initialize() {
        assert app_id_col != null : "fx:id=\"app_id_col\" was not injected: check your FXML file 'Doctor.fxml'.";
        assert firstName_col != null : "fx:id=\"firstName_col\" was not injected: check your FXML file 'Doctor.fxml'.";
        assert lastName_col != null : "fx:id=\"lastName_col\" was not injected: check your FXML file 'Doctor.fxml'.";
        assert logOut_btn != null : "fx:id=\"logOut_btn\" was not injected: check your FXML file 'Doctor.fxml'.";
        assert logout_btn != null : "fx:id=\"logout_btn\" was not injected: check your FXML file 'Doctor.fxml'.";
        assert nextPatient_btn != null : "fx:id=\"nextPatient_btn\" was not injected: check your FXML file 'Doctor.fxml'.";
        assert patientId_col != null : "fx:id=\"patientId_col\" was not injected: check your FXML file 'Doctor.fxml'.";
        assert patients_table != null : "fx:id=\"patients_table\" was not injected: check your FXML file 'Doctor.fxml'.";
        assert reload_btn != null : "fx:id=\"reload_btn\" was not injected: check your FXML file 'Doctor.fxml'.";
